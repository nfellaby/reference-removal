process SINGLE_REFERENCE_REMOVAL {
    ...
    */
    ...
    publishDir "${params.outdir}/removal/${sample_id}_single_reads", mode: params.publish_dir_mode
...
process PAIRED_REFERENCE_REMOVAL {
    ...
    */
    ...
    tag "${sample_id}"
    maxRetries 3
    publishDir "${params.outdir}/removal/${sample_id}_paired_reads", mode: params.publish_dir_mode
