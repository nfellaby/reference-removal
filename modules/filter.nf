process LONG_REFERENCE_REMOVAL {
    ...
    */
    ...
    output:
    tuple val(sample_id), path("${sample_id}.sample_summary.json"), path("${sample_id}.sample_reads.fq.gz"), emit: ref_removed
...
process LONG_SAMPLE_REMOVAL {
    ...
    */
    ...
    output:
    tuple val (sample_id), path("${sample_id}.reference_summary.json"), path("${sample_id}.reference_reads.fq.gz"), emit: sample_removal
...
process PAIRED_REFERENCE_REMOVAL {
    ...
    */
    ...
    output:
    tuple val(sample_id), path("${sample_id}.sample_summary.json"), path("${sample_id}.sample_reads.R1.fq.gz"), path("${sample_id}.sample_reads.R2.fq.gz"), emit: ref_removed
...
process PAIRED_SAMPLE_REMOVAL {
    ...
    */
    ...
    output:
    tuple val(sample_id), path("${sample_id}.reference_summary.json"), path("${sample_id}.reference_reads.R1.fq.gz"), path("${sample_id}.reference_reads.R2.fq.gz"), emit: sample_removal
